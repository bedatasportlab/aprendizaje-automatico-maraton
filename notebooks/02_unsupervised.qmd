...
Hasta ahora se ha visualizado la maratón como una foto fija de lo que ha ocurrido. Con el clustering en streaming se observan cómo han cambiado los grupos de carreras a lo largo de los tramos en función de la fatiga y los cambios de ritmo. Para este último apartado del análisis no supervisado se toma a las atletas de élite de la maratón de 2015 como muestra de estudio.
...
# --- A. ANÁLISIS POR TIEMPOS ACUMULADOS ---
col_acumuladas = []
splits = ['5k', '10k', '15k', '20k', '25k', '30k', '35k', '40k', 'official_time']
...
# Crear un DataFrame para la comparativa de K
df_k = pd.DataFrame({
